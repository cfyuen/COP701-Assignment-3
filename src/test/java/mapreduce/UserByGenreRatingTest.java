...
public class UserByGenreRatingTest {
    ...
    MapDriver<Object, Text, UserGenre, IntWritable> mapDriver;
    ReduceDriver<UserGenre, IntWritable, UserGenre, IntWritable> reduceDriver;
    MapReduceDriver<Object, Text, UserGenre, IntWritable, UserGenre, IntWritable> mapReduceDriver;
	...
	public void mapperTest() throws IOException {
		...
		mapDriver.withOutput(new UserGenre("uwip","constructive algorithms"), new IntWritable(1800));
		mapDriver.withOutput(new UserGenre("uwip","brute force"), new IntWritable(2000));
		mapDriver.withOutput(new UserGenre("uwip","implementation"), new IntWritable(2000));
		mapDriver.withOutput(new UserGenre("uwip","implementation"), new IntWritable(2300));
	...
	public void reducerTest() throws IOException {
		...
		UserGenre ug = new UserGenre("uwip","implementation");
	...
	public void mapReduceTest() throws IOException {
		...
		mapReduceDriver.withOutput(new UserGenre("uwip","constructive algorithms"), new IntWritable(1800));
		mapReduceDriver.withOutput(new UserGenre("uwip","brute force"), new IntWritable(2000));
		mapReduceDriver.withOutput(new UserGenre("uwip","implementation"), new IntWritable(2150));
